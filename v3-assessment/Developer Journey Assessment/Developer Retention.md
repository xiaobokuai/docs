...
Definition: Evaluating the community's ability to retain core developers, reflecting the community's effectiveness in retaining key talent and potential for sustainable development.

# Assessment Model

**Core Developer Retention**

| Metric | URL | Threshold | Weight |
| ------ | --- | --------- | ------ |
| Organizational Code Core Developer (including managers) Retention Rate | [/api/v3/core_retention/org_code_core_retention](https://oss-compass.org/dataHub#api_v3_core_retention_org_code_core_retention) | 1 | 0.25 |
| Organizational Issue Core Developer (including managers) Retention Rate | [/api/v3/core_retention/org_issue_core_retention](https://oss-compass.org/dataHub#api_v3_core_retention_org_issue_core_retention) | 1 | 0.25 |
| Individual Code Core Developer (including managers) Retention Rate | [/api/v3/core_retention/individual_code_core_retention](https://oss-compass.org/dataHub#api_v3_core_retention_individual_code_core_retention) | 1 | 0.25 |
| Individual Issue Core Developer (including managers) Retention Rate | [/api/v3/core_retention/individual_issue_core_retention](https://oss-compass.org/dataHub#api_v3_core_retention_individual_issue_core_retention) | 1 | 0.25 |

**Core Developer Churn**

| Metric | URL | Threshold | Weight |
| ------ | --- | --------- | ------ |
| Organizational Code Core Developer (including managers) Churn Rate | [/api/v3/core_churn/org_code_core_churn](https://oss-compass.org/dataHub#api_v3_core_churn_org_code_core_churn) | 1 | 0.25 |
| Organizational Issue Core Developer (including managers) Churn Rate | [/api/v3/core_churn/org_issue_core_churn](https://oss-compass.org/dataHub#api_v3_core_churn_org_issue_core_churn) | 1 | 0.25 |
| Individual Code Core Developer (including managers) Churn Rate | [/api/v3/core_churn/individual_code_core_churn](https://oss-compass.org/dataHub#api_v3_core_churn_individual_code_core_churn) | 1 | 0.25 |
| Individual Issue Core Developer (including managers) Churn Rate | [/api/v3/core_churn/individual_issue_core_churn](https://oss-compass.org/dataHub#api_v3_core_churn_individual_issue_core_churn) | 1 | 0.25 |

**Core Developer Loss**

| Metric | URL | Threshold | Weight |
| ------ | --- | --------- | ------ |
| Organizational Code Core Developer (including managers) Loss Rate | [/api/v3/core_loss/org_code_core_loss](https://oss-compass.org/dataHub#api_v3_core_loss_org_code_core_loss) | 1 | 0.25 |
| Organizational Issue Core Developer (including managers) Loss Rate | [/api/v3/core_loss/org_issue_core_loss](https://oss-compass.org/dataHub#api_v3_core_loss_org_issue_core_loss) | 1 | 0.25 |
| Individual Code Core Developer (including managers) Loss Rate | [/api/v3/core_loss/individual_code_core_loss](https://oss-compass.org/dataHub#api_v3_core_loss_individual_code_core_loss) | 1 | 0.25 |
| Individual Issue Core Developer (including managers) Loss Rate | [/api/v3/core_loss/individual_issue_core_loss](https://oss-compass.org/dataHub#api_v3_core_loss_individual_issue_core_loss) | 1 | 0.25 |

# Metrics in Assessment Model

## Core Developer Retention

The core developer retention model focuses on the continued participation of core developers in community contributions, which is a key indicator for evaluating the community's ability to retain talent.
...
The core developer churn model focuses on the situation where core developers are downgraded from the core level to regular or visitor level, reflecting the health of community talent flow.
...
The core developer loss model focuses on the situation where core developers completely leave the community, which is an important indicator for evaluating the risk of community talent loss.
